...
public class Message {
    ...
    public static final String EXCLUDE_ACCOUNT = "<RED-BOLD>Excluir</RED-BOLD> Conta";

    public static final String ILLEGAL_DEPOSIT_VALUE_FORMAT = "\n<RED-BOLD>Valor de depósito inválido</RED-BOLD>.\n";
    ...
    public static final String ILLEGAL_WITHDRAW_VALUE_FORMAT = "\n<RED-BOLD>Valor de saque inválido</RED-BOLD>. Por favor, insira o valor que deseja sacar: ";

    public static final String ILLEGAL_WITHDRAW_VALUE = "\n<RED-BOLD>Valor de saque inválido</RED-BOLD>.\n";
